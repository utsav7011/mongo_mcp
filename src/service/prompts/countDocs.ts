...
const countDocsPrompt = async (args: {
  ...
  const promptMessage =
    `Count documents in the MongoDB with cluster: ${connectionString} in database "${dbName}", collection "${collectionName}".` +
    (query
...
export default countDocsPrompt;