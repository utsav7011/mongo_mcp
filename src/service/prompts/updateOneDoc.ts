...
const updateOneDocPrompt = async (args: {
  ...
  const promptMessage =
    `Update one document in the MongoDB with cluster: ${connectionString} in database "${dbName}", collection "${collectionName}".` +
...
export default updateOneDocPrompt;
